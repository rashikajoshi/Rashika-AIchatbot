                ...
                <div className="space-y-4">
                    ...
                    <ol className="list-decimal list-inside space-y-3">
                        <li className="text-gray-700">
                            ...
                            is intended solely to assist users with Interview/Placement preparation. The AI Chatbot is not
                            affiliated with, endorsed by, or operated by the owners.
                        </li>
                        <li className="text-gray-700">
                ...
                <div className="space-y-4">
                    ...
                    <ol className="list-decimal list-inside space-y-3">
                        ...
                        <li className="text-gray-700">
                            ...
                            Under no circumstances shall {OWNER_NAME}, their collaborators,
                ...
                <div className="space-y-4">
                    ...
                    <ol className="list-decimal list-inside space-y-3">
                        ...
                        <li className="text-gray-700">
                            ...
                            {OWNER_NAME} reserve the right to use any input provided by users and
